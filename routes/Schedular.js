...
const resetToken=require("../App/Http/Models/resetToken");
const sendEmail = require('../App/Http/Utils/sendEmail');
...
//Get all Method
router.get('/courses',urlencodedParser, async function (req, res) {
